      ...
      {menuState && (
        <div className={styles.menu} ref={menuRef}>
          ...
          <div className={`${styles.socials} grid`} ref={thirdRef}>
            ...
            <a
              href='https://www.youtube.com/channel/UCJnjjsoVBYlZEB9ATojj7-Q'
              className={`${styles.youtube} flex`}
              target='_blank'
              rel='noreferrer'
            >
              <svg
            ...
            <a
              href='https://twitter.com/miastoswiatel'
              className={`${styles.twitter} flex`}
              target='_blank'
              rel='noreferrer'
            >
              <svg
            ...
            <a
              href='https://www.tiktok.com/@city.of.lights'
              className={`${styles.tiktok} flex`}
              target='_blank'
              rel='noreferrer'
            >
              <svg
